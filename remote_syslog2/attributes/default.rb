...
default['remote_syslog2']['install']['download_file'] = 'https://raw.githubusercontent.com/papertrail/remote_syslog2/releases/download/v0.17/remote_syslog_linux_i386.tar.gz'
